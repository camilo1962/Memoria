...
public class _CardGameManager : MonoBehaviour
{
    ...
    // El propósito es permitir la precarga del panel, para que no se retrase cuando se carga
    // Llame a esto en el método de inicio para precargar todos los sprites al comienzo del scriptt
    ...
    {
        if (gameStart) return; // volver si el juego ya se está ejecutando
        gameStart = true;
        // toggle UI
